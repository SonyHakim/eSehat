    ...
    if request.POST:
        ...
        if user is not None:
            if user.is_active:
                ...
                if request.session['jenis_akun'] == "dokter" or request.session['jenis_akun'] == "dokter_gigi" or request.session['jenis_akun'] == "dokter_kia" or request.session['jenis_akun'] == "dokter_gizi":
                    return redirect('/dokter/index') # sudah login ini
                elif request.session['jenis_akun'] == "pegawai_admin" or request.session['jenis_akun'] == "perawat": 
                    return redirect('/pegawaiadmin/index') # sudah login ini
                # elif request.session['jenis_akun'] == "perawat": 
                #     return redirect('/perawat/index') # sudah login ini
