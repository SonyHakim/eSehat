...
JAZZMIN_SETTINGS = {
    # title of the window
    'site_title': 'Admin Pelayanan Klinik',

    # Title on the brand, and the login screen (19 chars max)
    'site_header': 'e-Sehat Klinik Az-Zainiyah',

    # square logo to use for your site, must be present in static files, used for favicon and brand on top left
    'site_logo': '../static/vendor/adminlte/img/esehatbul.png',

    # Welcome text on the login screen
    'welcome_sign': 'Admin e-Sehat Klinik Az-Zainiyah',
